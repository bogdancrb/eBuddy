 ...
 */
class ResetPasswordController extends FOSRestController implements ClassResourceInterface
{
    /**
    ...
    public function requestResetAction(Request $request)
    {
        ...
        $user = $this->get('fos_user.user_manager.default')->findUserByUsernameOrEmail($username);
